...
Best Practice:
- если это можно сделать через Inspector - лучше так и сделать, до оптимизаций далеко, 
       а Unity очень много работы умеет делать сам, позволим ему её делать хорошо.
*/

/* TODO по Audio
- Tools - Object with Component - WorldAudioPlayer {}
              - подписывается на Event и управлять состоянием Аудио внутри.
- Docs - побольше, что бы Макс так не ахуевал. =)))
